  ...
  return (
    <StationShell id="projects" eyebrow="Station 04" title="Engineering modules" index={3}>
      <p className="mb-10 max-w-2xl text-pretty text-accent">
        Selected builds presented as illuminated bays along the bore. Hover to engage depth
        and lighting — each module is a discrete system, not a generic card.
      </p>
            ...
            <div className="relative flex flex-col gap-5 p-6 sm:p-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-2 font-display text-xl text-bone sm:text-2xl">
                    {project.name}
                  </h3>
                </div>
                <Link
